...
export type ParsleyMessage<T = unknown> = z.infer<typeof ParsleyMessageSchema> & { data: T | null }
export type CANCommandMessage<T = unknown> = z.infer<typeof CANCommandMessageSchema> & { canMsg: T | null }
